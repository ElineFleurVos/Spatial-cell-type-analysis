...
%% I'm plotting the results here; not sure how you want to incorporate this into your code
    ...
    ylim(ylimits);
    text(cutoff+0.1,mean(ylimits)+0.05,['cutoff=' num2str(cutoff,2), newline, '%pos=' num2str(100*sum(poscells)/length(poscells),'%2.1f'), newline, 'FDR=' num2str(FDR+sqrt(min(objfunc)),2)],'fontsize',12)
