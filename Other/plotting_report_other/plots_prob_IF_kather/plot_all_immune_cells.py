# -*- coding: utf-8 -*-
"""
Created on Wed Feb  5 10:11:08 2025
...
predictions_dir_MIL = "C:/Users/20182460/Desktop/Master_thesis/Code/Outputs/FINAL RESULTS/CRC/MIL/MIL_extend_cell_types/PC_CHiP/pcchip_all_cell_types.csv"
...
#predictions_dir_T = r"C:/Users/20182460/Desktop/Master_thesis/Code/Outputs/FINAL RESULTS/CRC/MIL/MIL_UNI_FF_FFPE_tests/T/T_norm_macenko_FFPE.csv"
...
cmap_cell_types = {"T_cells": "Greens", "CD4_T_cells": "Greens",
                   "CD8_T_cells": "Greens", "B_cells": "Reds", "macrophages": "Blues"}


#(22,2.1)
fig, axs = plt.subplots(3, 5, figsize=(22,8), gridspec_kw={
...
axs[2,1].set_title(r"IF map CD8$\alpha$", fontsize=15)
...
sns.heatmap(fluorescence_grid_CD20, cmap='viridis', vmin=0, vmax=threshold_CD163_68,
            xticklabels=False, yticklabels=False, ax=axs[0,3])
axs[0,3].set_title("IF map CD20", fontsize=15)
axs[0,3].set_aspect(image_aspect)

sns.heatmap(prob_grid_MIL_B, cmap=cmap_cell_types['B_cells'], vmin=0.2, vmax=0.8,
            xticklabels=False, yticklabels=False, ax=axs[0,4])
axs[0,4].set_title("B prob. map MIL", fontsize=15)
axs[0,4].set_aspect(image_aspect)


sns.heatmap(fluorescence_grid_macro, cmap='viridis', vmin=0, vmax=threshold_CD163_68,
            xticklabels=False, yticklabels=False, ax=axs[1,3])
axs[1,3].set_title("IF map CD163 + CD68", fontsize=15)
axs[1,3].set_aspect(image_aspect)

sns.heatmap(prob_grid_MIL_macro, cmap=cmap_cell_types['macrophages'], vmin=0.2, vmax=0.8,
            xticklabels=False, yticklabels=False, ax=axs[1,4])
axs[1,4].set_title("Macrophages prob. map MIL", fontsize=15)
axs[1,4].set_aspect(image_aspect)

axs[2,3].axis('off')
axs[2,4].axis('off')

output_dir_plot = r"C:\Users\20182460\Desktop\Master_thesis\Figures report\extension_cell_types\examples_all_immune"
plt.savefig(f"{output_dir_plot}/{method}_{slide_id}_immune_cells.png", dpi=300, bbox_inches="tight")
