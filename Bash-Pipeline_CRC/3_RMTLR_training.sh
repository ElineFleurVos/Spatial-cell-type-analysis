...
tpm_dir=$data_dir/TCGA_CRC/TCGA_tpm_CRC.txt
...
celltype="CAFs" #CAFs, endothelial_cells, T_cells, tumor_purity

#Each cell type separate
echo "$celltype"
python $code_dir/3_training/run_TF_pipeline_CRC.py \
...
cell_types_dir=$code_dir/3_training/cell_types_list.txt
