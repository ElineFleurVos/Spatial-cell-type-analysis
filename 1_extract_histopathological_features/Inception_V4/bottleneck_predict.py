...
tf.app.flags.DEFINE_string(
    "bot_out", r"D:\Outputs\SKCM\FF\1_extract_histopathological_features\bot.train.txt", "Output file for bottleneck features."
)
tf.app.flags.DEFINE_string(
    "pred_out", r"D:\Outputs\SKCM\FF\1_extract_histopathological_features\pred.train.txt", "Output file for predictions."
)
tf.app.flags.DEFINE_string(
    "model_name", "inception_v4", "The name of the architecture to evaluate."
)
tf.app.flags.DEFINE_string(
    "checkpoint_path", r"D:\Data\Model weights v4\Retrained_Inception_v4_alt\model.ckpt-100000", "The directory where the model was written to."
)
tf.app.flags.DEFINE_integer("eval_image_size", 299, "Eval image size.")
tf.app.flags.DEFINE_string("file_dir", r"D:\Outputs\SKCM\FF\1_extract_histopathological_features\process_train", "")
...
def main(_):
    ...
    eval_image_size = int(FLAGS.eval_image_size)
    ...
    network_fn = nets_factory.get_network_fn(
        FLAGS.model_name, int(FLAGS.num_classes), is_training=False
    )
    ...
    print("Finished making tile predictions")
