...
def format_tile_data_structure(slides_dir, output_dir, clinical_file_dir):
    """
    ...
    # 2) Determine the paths of jpg tiles
    ...
    slide_quality = []
    print(jpg_tiles_df.image_file_name.unique())
    for slide_name in jpg_tiles_df.image_file_name.unique():
        print(slide_name)
        img = OpenSlide("{}/{}".format(slides_dir, slide_name))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir_tiles", help="Set output folder for tiles")
    ...
    format_tile_data_structure(
        ...
        output_dir_tiles=args.output_dir_tiles,
