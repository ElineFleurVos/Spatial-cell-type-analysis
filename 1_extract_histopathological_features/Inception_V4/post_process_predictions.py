...
def post_process_predictions(codebook_dir, tissue_classes_dir, output_dir, slide_type):
    """
    ...
    # Initialize
    codebook = pd.read_csv(codebook_dir, delim_whitespace=True, header=None)
    codebook.columns = ["class_name", "class_id"]
    tissue_classes = pd.read_csv(tissue_classes_dir, sep="\t")
